...
namespace itk
{
    ...
    DummyFilter<TInputImage, TOutputImage1, TOutputImage2>::DummyFilter()
    {
    ...
    template< typename TInputImage, typename TOutputImage1, typename TOutputImage2>
    void DummyFilter<TInputImage, TOutputImage1, TOutputImage2>::GenerateData()
    {
        itk::Index<2> start;
        start.Fill(0);
    ...
    template< typename TInputImage, typename TOutputImage1, typename TOutputImage2>
    DataObject::Pointer DummyFilter<TInputImage, TOutputImage1, TOutputImage2>::MakeOutput(unsigned int idx)
    {
    ...
    template< typename TInputImage, typename TOutputImage1, typename TOutputImage2>
    TOutputImage1* DummyFilter<TInputImage, TOutputImage1, TOutputImage2>::GetOutput1()
    {
        return dynamic_cast< TOutputImage1 * >(this->ProcessObject::GetOutput(0) );
    }

    template< typename TInputImage, typename TOutputImage1, typename TOutputImage2>
    TOutputImage2* DummyFilter<TInputImage, TOutputImage1, TOutputImage2>::GetOutput2()
    {
...
#endif //ITKBULLSEYE_ITKDUMMYFILTER_HXX
